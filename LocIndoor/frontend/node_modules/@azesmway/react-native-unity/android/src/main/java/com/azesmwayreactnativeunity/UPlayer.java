...
public class UPlayer {
    ...
    public FrameLayout requestFrame() throws NoSuchMethodException {
        try {
            ...
            // For Unity 6+, create a wrapper FrameLayout and return it
            if (frameLayout == null) {
                frameLayout = new FrameLayout(activity);
                // UnityPlayer is not a View in Unity 6+, so we cannot add it directly here.
                // The RN plugin will manage attaching the Unity content to the activity/window.
            }
            return frameLayout;
        }
    }
